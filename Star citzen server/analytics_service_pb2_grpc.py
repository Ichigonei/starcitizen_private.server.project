...
class AnalyticsServiceStub(object):
    ...
    def __init__(self, channel):
        ...
        """
        self.CollectionStream = channel.stream_stream(
                '/sc.external.services.analytics.v1.AnalyticsService/CollectionStream',
        ...
        self.SendEvent = channel.unary_unary(
                '/sc.external.services.analytics.v1.AnalyticsService/SendEvent',
                request_serializer=analytics__service__pb2.AnalyticsEvent.SerializeToString,
                response_deserializer=analytics__service__pb2.AnalyticsResponse.FromString,
                _registered_method=True)
...
class AnalyticsServiceServicer(object):
    ...
    def CollectionStream(self, request_iterator, context):
        """Missing associated documentation comment in .proto file."""
...
def add_AnalyticsServiceServicer_to_server(servicer, server):
    rpc_method_handlers = {
            'CollectionStream': grpc.stream_stream_rpc_method_handler(
                    servicer.CollectionStream,
    ...
    generic_handler = grpc.method_handlers_generic_handler(
            'sc.external.services.analytics.v1.AnalyticsService', rpc_method_handlers)
    server.add_generic_rpc_handlers((generic_handler,))
    server.add_registered_method_handlers('sc.external.services.analytics.v1.AnalyticsService', rpc_method_handlers)
...
class AnalyticsService(object):
    ...
    @staticmethod
    def CollectionStream(request_iterator,
            target,
            options=(),
